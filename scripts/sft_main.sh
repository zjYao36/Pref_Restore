...
PRETRAINED_MODEL=/data/phd/hf_models/Unified-Models/BLIP3o/BLIP3o-NEXT-Pretrain-3B
...
EPOCH=100
# DATA_PATH=/data/phd/data/unified_model/T2I_sft/
# EPOCH=60

LR=5e-5
RUN_NAME="SFT_BLIP3o60k_placeholder"
# RUN_NAME="SFT_BLIP3o60k_ShareGPT-4o-Image"
