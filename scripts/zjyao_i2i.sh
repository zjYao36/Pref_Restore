...
# DATA_PATH=/data/zgq/yaozhengjian/Datasets/FFHQ/zjyao_data_txt/train_data_celeba-enhance.txt   # bsz128, 5 个epoch是 2850 iters
...
# LR=2e-5 
LR=1e-4 
# RUN_NAME="Face-Restoration_FFHQ_Step1_ablation_training-curve"
# RUN_NAME="Face-Restoration_FFHQ_Step1_ablation_training-curve_V2-noText"
# RUN_NAME="Face-Restoration_FFHQ_Step1_ablation_training-curve_V3-fewerData"
# RUN_NAME="Face-Restoration_FFHQ_Step1_ablation_training-curve_V4-woRecon"
# RUN_NAME="Face-Restoration_FFHQ_Step1_ablation_training-curve_V5-LR1-4"
